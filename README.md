...
1. *Human Digital Twin Modeling for Cardiovascular System* (2025) — Scientific Journal of Informatics  
2. *Implementasi Teknologi Artificial Intelligence untuk Interdisipliner Ilmu* (2025) — Book, Deepublish  
3. *Semantic Segmentation of Rice Leaf Blast Disease Using Optimized U-Net* (2022) — CENIM (IEEE)  

**Full list:** [Publications](/nashehannafii.github.io/publications/)  
**Citations:** 33 (Google Scholar, Mar 2026)
